    ...
    <div class="container mx-auto">
        ...
        <div v-if="trashedUsers.length > 0">
            <div v-for="user in trashedUsers" :key="user.id">
                <div>
                    <!-- shows users name with prefix etc -->
                ...
                <div>
                    <!-- shows users when user was deleted -->
                    Deleted At: {{ new Date(user.deleted_at).toLocaleDateString() }}
                </div>
                <!-- buttons that call restoreUser to undo the soft delete, or forceDeleteUser which removes them from the database totally -->
